...
export const TomatoMascotIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
      {/* Leaves */}
      <path className="text-green-400" fill="currentColor" d="M12 1.5c.66 0 1.25.22 1.76.58.62.42 1.29.84 2.15.84.85 0 1.62-.24 2.24-.82.63-.58.98-1.02.98-1.54 0-.3-.09-.59-.26-.85C20.35.43 19.71 0 18.94 0c-1.08 0-2.1.66-2.92 1.58-.55.62-1.39 1.42-2.58 1.42s-2.03-.8-2.58-1.42C10.04.66 9.02 0 7.94 0c-.77 0-1.41.43-1.92.79-.17.26-.26.55-.26.85 0 .52.35.96.98 1.54.91.83 1.76 1.18 2.62 1.18.85 0 1.62-.24 2.24-.82C10.75 1.72 11.34 1.5 12 1.5z" />
      {/* Body */}
      <path className="text-red-500" fill="currentColor" d="M17.29 5.29C15.93 4.28 14.08 3 12 3S8.07 4.28 6.71 5.29C4.5 6.84 3 9.25 3 12c0 3.31 2.69 6 6 6h6c3.31 0 6-2.69 6-6 0-2.75-1.5-5.16-3.71-6.71z" />
    </svg>
);
...
export const EnvironmentIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
